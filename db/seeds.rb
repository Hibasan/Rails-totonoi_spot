...
Review.create!([
  ...
  {user_id: 3, sex: 2,facility_id: 1, dry:4, light: 4, wide: 2, comment: "サウナイキタイ書かなきゃ……と寝落ちしたので朝書いてます。15時熱波に間に合うようチェックイン。パンダ小隊が。心臓をキュンと射撃されて靴箱へ。またひとつ井上さんの詩が、役目を終えゴートゥーヘブンした靴箱を葬送しておられました。ありがとう。"  },
  {user_id: 4, sex: 1,facility_id: 1, dry:5, light: 4, wide: 2, comment: "土曜これなかったので意気込みすぎて15分前にサ室にイン。シッダアーサナで待ち構えます。始まる前に井上さんと復火さんが来て「サ室の匂い対策」と、アロマ湯バケツをストーブの上に。いい湿度が身体を包みこみ深部体温あっつあつ。"  },
  {user_id: 5, sex: 2,facility_id: 1, dry:3, light: 3, wide: 2, comment: "その後オルカさんと眞白さんが一旦空気を入れ替えてくれたものの、もはや完全にデキアガっていました。ロウリュ前に合言葉聞いただけで未来への扉から水風呂へゴートゥーヘブン！外気浴では陽が暖かくいい風が吹いていて、しっかり拭いた肌からぷちぷちと毛穴が開いていき最高にととのいました。気持ち良すぎてニヤニヤ薄ら笑いを浮かべてしまいましたが、人目を気にしてニヤニヤを辞めるとトトノイも薄れるので顔面放置w"  },
  {user_id: 2, sex: 1,facility_id: 1, dry:4, light: 4, wide: 4, comment: "あまりにも良い風が吹いてるので、風を送りに廻る眞白さんも照れくさそうw 私はニヤニヤのまま会釈。さぞ気持ち悪かったことでしょう。気づくとノドがカラッカラ。一時退場してパネジョッキオールフリーと遅めのお昼。中ジョッキ、大ジョッキ、その上がパネジョッキ。パネってなんじゃろ。じゃろーじゃろーじゃろー♪という昔のCMを頭で流しながらゴキュゴキュと流し込むとノドから身体全体へ至福が拡がります。カツカレーとイカフライの揚げ二段構えとオールフリーが最高に調和しました。ごちそうさまでした。"  },
  {user_id: 3, sex: 2,facility_id: 3, dry:5, light: 1, wide: 5, comment: "なんだかんだ言って、お風呂も沢山&広々ですし、脱衣所とかも清潔。（そりゃちとお高いし。）京急平和島や京浜東北大森まで無料バスもあって楽ちん。旅行が再開したら、きっと羽田帰りに寄るでしょう。寄りたいな。あー楽しかった。"  },
  {user_id: 4, sex: 1,facility_id: 3, dry:1, light: 1, wide: 4, comment: "高温サウナ90℃×10分、水風呂20℃×2分、ビューイング付近のトトノイベンチもしくは腰湯で5分を3セット。水風呂はバイブラ無し20℃と入りやすい温度です。長く入れました。"  },
  {user_id: 5, sex: 2,facility_id: 3, dry:2, light: 1, wide: 2, comment: "次に高温サウナを偵察。90℃表記、少し乾燥。広いサ室に持ち込みマットもあるので、敷いてあるマットも綺麗さっぱり。テレビ付き。密回避のためにカラーコーンが置いてありますが、まぁ平日昼間ですし2.3人程度。"  },
  {user_id: 2, sex: 1,facility_id: 3, dry:3, light: 4, wide: 3, comment: "次にビューイングスパ。ビューイングの意味なのかわかりませんが、3段の大きな大きな休憩スペースがテレビに向いてます。天然温泉と炭酸湯。"  },
  {user_id: 3, sex: 2,facility_id: 1, dry:4, light: 3, wide: 1, comment: "まずはシャイニングスパ。天井や窓からの光がとっても明るい！こちらの温泉は塩気のお風呂。ラクーアみたいな塩化物泉。バイブラの白湯などもあり、とにかく広々開放的です。"  },
  {user_id: 4, sex: 1,facility_id: 12, dry:5, light: 1, wide: 1, comment: "こちらは岩盤浴のロウリュイベントが有名ですが、温泉とサウナを楽しみたくて岩盤浴無し。マッサージも種類豊富。スパ銭で鍼、しかも美容鍼やってるトコなんて初めて見ました。（まだ知らない世界が多い）誘惑に負けそうになりながらお風呂へ。"  },
  {user_id: 5, sex: 2,facility_id: 16, dry:1, light: 2, wide: 4, comment: "テルマリウムを挟んでハーブの香りが残るサウナ室にもう一度。もはや完成間近な状態で浴室をあとにしてレストランへ。塾中に師が激推ししていた一人鍋に雑炊セットで、完成。まさにメイドインヘブン。"  },
  {user_id: 2, sex: 1,facility_id: 7, dry:2, light: 3, wide: 3, comment: "師がタオルに手をかける前に離脱者が出会うはじめる。うん、今日の新橋熱波道場は…あつい。なかなか出来上がってきたコンディションを静かに深く呼吸していると、ここで『じゃあ108熱波行きますよ』とのコトバが聞こえた。ヤバい。かなり熱いぞ。大丈夫か？ワタシ。"  },
  {user_id: 3, sex: 2,facility_id: 7, dry:3, light: 5, wide: 4, comment: "休憩スペースにあるバキバキイス。正式名称は『テルマベッド』だが、ここに座るとバキバキに整い、正直立てなくなるため仲間の間ではバキバキイスとか呼ばれてたりする。あまりにもバキバキに整いすぎてめちゃ強面の力道山みたいなオッさんがここで2時間ぐらい爆睡してどいてくれない事件も発生した。めちゃくちゃみんな怒ってた。おのれ、、、、"  },
  {user_id: 4, sex: 1,facility_id: 5, dry:4, light: 5, wide: 5, comment: "素晴らしいところは水風呂である。ここの水風呂は水温約14〜17度くらい。常に適温であり、寒過ぎず、ぬる過ぎず、サウナーが求める整いへ誘ってくれる裏切ることのない仕事をする。某か○まるのような寒すぎて全く入れない水風呂や、ぬるすぎて全然整わない両極端なやつを体験すると、如何にこの水風呂が素晴らしいかわかる。"  },
  {user_id: 5, sex: 2,facility_id: 2, dry:5, light: 3, wide: 5, comment: "入館したらいざサウナへ。身体を清めたらまずはドライサウナ。ここはテレビがないため静かになりたい人にはうってつけ。"  },
  {user_id: 2, sex: 1,facility_id: 1, dry:3, light: 4, wide: 5, comment: "僕が初めてサウナに目覚めた場所、アスティル。サウナーが求めるものがシンプルイズベストに濃縮され一つ一つのクオリティが高く、無駄のないサウナである。故に僕の中で東京トップサウナとして君臨する。"  },
  {user_id: 3, sex: 2,facility_id: 1, dry:4, light: 3, wide: 5, comment: "サウナ：10分 × 3水風呂：1分 × 3休憩：10分 × 3合計：3セット一言：今の私にとっては水温が少し物足りないが、なんかこの温度は温度でゆったり入れていいかもしれない。原点回帰するような場所である。"  },
  {user_id: 4, sex: 1,facility_id: 12, dry: 5, light: 3, wide: 1, comment: "あがって長時間まったり。21時のサウナ歌謡ショー観覧へ。大西さんが歌うと機械の調子が悪くなってアカペラになったりとなかなかトラブル連続の歌謡ショーでした。"  },
  {user_id: 5, sex: 2,facility_id: 13, dry: 3, light: 1, wide: 3, comment: "まったり食休みしてから17時熱波のため再入場。井上さん復火さんからの108連波をツヤツヤお肌の天谷さんの正拳突きと共にしっかり受けきったら水風呂と岩の上に座って外気浴。お尻が冷たくない良い季節になりました。"  }
  ])
